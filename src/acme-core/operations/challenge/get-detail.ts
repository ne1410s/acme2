...
import {
  IGetChallengeDetailRequest,
  IGetChallengeDetailResponse,
} from '../../interfaces/challenge/get-detail';
...
> {
  ...
  protected async invokeInternal(
    requestData: IGetChallengeDetailRequest
  ): Promise<IGetChallengeDetailResponse> {
